<template>
  <view class="page-rank">
    ...
    <view v-else class="rank-list">
      ...
      >
        ...
        <view class="rank-stats">
          <text class="stat-acc">{{ formatAccuracy(item.accuracy) }}%</text>
          <text class="stat-total">{{ item.totalAnswer || 0 }}题</text>
        </view>
      </view>
	...
	<view class="my-rank rank-item card is-me">
	  ...
	  <view class="rank-stats">
	    <text class="stat-acc">{{ formatAccuracy(userInfo.accuracy) }}%</text>
	    <text class="stat-total">{{ userInfo.totalAnswer || 0 }}题</text>
	  </view>
	</view>
